        ...
        <div class="row">
          <div class="col-md-5">
            ...
            <div class="ticket_form">
              ...
              <div class="btn-group"> <a href="javascript:void(0)" class="btn btn-sm ticket_btn_2">Pelayanan</a> </div>
              <br/>
              <br/>
              ...
              <div class="ticket_option">
                <div class="form_ticket_subject"><span class="semi-bold">No. Inventory</span>
                  ...
                  <div class="">
                    <div class="input-group">
                      <input type="text" name="pemohon" class="form-control" required oninvalid="setCustomValidity('Nama Pemohon masih kosong')" oninput="setCustomValidity('')" placeholder="Masukan nama anda" >
                    </div>
                  </div>
